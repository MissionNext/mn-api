...
use App\Modules\Api\Service\Matching\TransData;
use App\Modules\Api\MissionNext\Controllers\BaseController;
use App\Modules\Api\Exceptions\SearchProfileException;
 ...
 * @package App\Modules\Api\MissionNext\Controllers\Profile
 */
    ...
    public function postIndex($searchType, $userType, $userId)
    {
        ...
        if (!empty($profileSearch)) {
            ...
            if (count($expandedFields)) {
                $expandedFields = array_pluck($expandedFields, 'symbol_key');
            }
