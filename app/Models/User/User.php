...
use App\Models\Role\Role as RoleModel;
...
class User extends ModelObservable implements ProfileInterface
{
     ...
     *
     * @throws \App\Modules\Api\Exceptions\ModelObservableException
     */
    public function setActiveOnApps(Application $application)
    {
         $this->onCreated(function($user) use ($application){
             /** @var $user User */
             $appIds = array_diff(Application::pluck('id')->all(), [$application->id()]);
