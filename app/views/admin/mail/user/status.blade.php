...
Current status is now: {{{ $user['is_active'] ? 'Access Granted' : 'Access Denied'  }}}
...
   
Please log in to your account from https://new.missionnext.org/welcome/login-here/ (after choosing the appropriate service) with your username and password to make your activation payment. Once your payment is received, you will receive instructions on how to set up your profile and post your jobs in order to make the most of your MissionNext partnership.   
...
   
MissionNext Partner Support Team  
Thank you,
MissionNext Team