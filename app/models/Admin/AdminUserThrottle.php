...
class AdminUserThrottle  extends Model implements ThrottleInterface {
    /**
     * Throttling status.
     *
     * @var bool
     ...
     * @var string
     */
    protected static $userModel = 'MissionNext\Models\Admin\AdminUserModel';
