...
use App\Modules\Api\Exceptions\FieldException;
...
//        $dm = $this->repoContainer->securityContext()->getApp()->DM();
    ...
    public function updateFields(array $fields)
    {
        ...
        foreach ($fields as $field) {
            ...
            if ($field["choices"]) {
                ...
                $currentChoicesIds = $model->choices()->get()->pluck('id');
                $updateChoiceIds = array_pluck($updateChoices, 'id');
    ...
    {
        $symbol_keys = $this->getModel()->whereIn("id", $ids)->pluck('symbol_key');
